...
# Output-directory
cross_sec_outputs = './cross_sec_outputs/C18O/'

files = dict(
    partition_function = f'{input_dir}/q26.txt', 
    transitions = f'{input_dir}/05_HITEMP2019.par.bz2', 
    
    tmp_output   = f'{cross_sec_outputs}'+'tmp/C18O_cross{}.hdf5', 
    final_output = f'{cross_sec_outputs}/C18O.hdf5', 
)
...
pRT = dict(
    out_dir         = f'{cross_sec_outputs}/C18O_pRT2/', 
...
mass = 30.0
isotope_idx = 3 # !! HITEMP specific !! .par-file includes all isotopologues
