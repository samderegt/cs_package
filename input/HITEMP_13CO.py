...
files = dict(
    ...
    tmp_output   = f'{cross_sec_outputs}'+'/13CO/tmp/13CO_cross{}.hdf5', 
    final_output = f'{cross_sec_outputs}/13CO/13CO.hdf5', 
)
...
pRT = dict(
    out_dir         = f'{cross_sec_outputs}/13CO/13CO_pRT2/', 
...
mass = 29.0
isotope_idx = 2 # !! HITEMP specific !! .par-file includes all isotopologues
